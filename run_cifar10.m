...
if exist(binary_test_file, 'file') ~= 0
    ...
    [feat_test , list_im_test] = feat_batch(use_gpu, model_def_file, model_file, test_file_list, feat_len);
...
if exist(binary_train_file, 'file') ~= 0
    ...
    [feat_train , list_im_train] = feat_batch(use_gpu, model_def_file, model_file, train_file_list, feat_len);
